...
const updateUser = async (req, res) => {
    try {
        ...
        const [customer, created] = await Customer.findOrCreate({
            ...
            defaults: { fname, lname, addressline, zipcode, phone, image_path: imagePath, user_id: userId }
        });
...
const deactivateUser = async (req, res) => {
    try {
        ...
        return res.status(200).json({ success: true, message: 'User deactivated successfully', email, deleted_at: timestamp });
    } catch (error) {
        console.log(error);
...
module.exports = { registerUser, loginUser, updateUser, deactivateUser, getAllUsers, updateUserRole };